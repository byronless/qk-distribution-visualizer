 ...
 */
var sibling = function( quadkey, direction ) {
	direction = {
		'left' : Direction.Left,
 ...
 */
var locationToPixel = function( coord, detail ) {
 ...
 */
var pixelToLocation = function( pixel, detail ) {
 ...
 */
var pixelToTile = function( pixel ) {
	return {
		x: (pixel.x / 256),
		y: (pixel.y / 256)
	};
 ...
 */
var tileToQuadkey = function( tile, detail ) {
	var out = "";
 ...
 * @return {xycoord}         tile coordinates
 */
var quadkeyToTile = function( quadkey ) {
	var tileX = 0
	  , tileY = 0
 ...
 */
var tileToLocation = function( tile, detail ) {
 ...
 */
var locationToQuadkey = function( location, detail ) {
 ...
 */
var inside = function( location, quadkey ) {
